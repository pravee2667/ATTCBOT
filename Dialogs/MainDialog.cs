        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            switch (luisResult.TopIntent().intent)
            {
                ...
                case FlightBooking.Intent.GetWeather:
                    ...
                    break;
                case FlightBooking.Intent.FirstLevel:
                    await stepContext.Context.SendActivityAsync("I shall be glad to help. Before we move forward, I wanted to let you know that this chat may be reviewed for quality assurance purposes and for further follow-up if needed.");
                    await Task.Delay(5000);
                    await stepContext.Context.SendActivityAsync("For security purposes I need to verify the customer’s phone-number or account-number before we continue. What is the phone or account number attached to the customer’s account?");
                    break;
                case FlightBooking.Intent.SecondLevel:
                    ...
                    await stepContext.Context.SendActivityAsync(replyFeedback, cancellationToken);
                    break;
                case FlightBooking.Intent.Network:
                    await stepContext.Context.SendActivityAsync("Thanks for the selection. Do you want to further illustrate the issue by typing or uploading a screenshot of the issue? ");
                    break;
